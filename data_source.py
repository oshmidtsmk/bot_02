import psycopg2
import logging # is needed for logging errors
...
class DataSource:
    ...
    def get_connection(self):
        """ The helper method to get connection """
    ...
    def get_all_reminders(self):
        """ Will be called by the background job which will check reminders to be fired. """
        conn = None
        reminders = list()
        try:
            conn = self.get_connection()
